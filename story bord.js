...
lib.ssMetadata = [
		{name:"story bord_atlas_1", frames: [[0,1739,572,251],[1068,767,216,249],[1327,1581,713,281],[360,0,270,311],[574,1739,572,251],[682,1017,216,249],[900,1017,121,121],[682,767,384,248],[592,522,78,118],[0,0,358,721],[1656,0,281,808],[1020,0,303,765],[682,0,336,762],[1327,0,327,755],[341,723,339,760],[592,642,62,45],[682,1268,246,115],[360,522,230,147],[0,723,339,761],[1600,810,269,769],[1327,757,271,780],[0,1697,312,10],[0,1486,312,209],[341,1485,984,252],[360,313,309,207]]},
		{name:"story bord_atlas_2", frames: [[1462,882,303,881],[839,330,311,887],[1462,0,306,880],[1152,0,308,885],[421,1015,416,681],[0,330,419,683],[421,330,416,683],[0,1015,419,683],[0,1700,1253,226],[0,0,936,328]]},
		{name:"story bord_atlas_3", frames: [[0,0,963,553],[965,0,858,475],[926,875,414,882],[1342,875,359,875],[0,875,503,879],[505,875,419,876],[0,555,1513,318]]},
		{name:"story bord_atlas_4", frames: [[1131,853,740,740],[1131,0,851,851],[0,1011,740,740],[0,0,1129,1009]]}
];
...
(lib.CachedBmp_86 = function() {
	this.initialize(ss["story bord_atlas_1"]);
	this.gotoAndStop(0);
...
(lib.CachedBmp_71 = function() {
	this.initialize(ss["story bord_atlas_4"]);
	this.gotoAndStop(0);
}).prototype = p = new cjs.Sprite();
...
}).prototype = getMCSymbolPrototype(lib.Symbol1, new cjs.Rectangle(-0.4,0,192,124), null);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-0.35,-0.1,0.4351,0.4351);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.Symbol12, new cjs.Rectangle(-0.3,-0.1,131.8,383.3), null);
...
}).prototype = getMCSymbolPrototype(lib.Symbol6, new cjs.Rectangle(-0.4,0,135.5,288.7), null);
...
}).prototype = getMCSymbolPrototype(lib.Symbol5, new cjs.Rectangle(-0.5,-0.1,117.3,285.70000000000005), null);
...
if (reversed == null) { reversed = false; }
	...
	this.instance_1.setTransform(-0.7,-0.4,0.3206,0.3206);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.Symbol4_1, new cjs.Rectangle(-0.7,-0.4,98.10000000000001,282.09999999999997), null);
...
}).prototype = getMCSymbolPrototype(lib.Symbol3_1, new cjs.Rectangle(-0.5,0,97,278.8), null);
...
if (reversed == null) { reversed = false; }
	...
	this.instance_1.setTransform(-0.65,0,0.2982,0.2982);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.Symbol2_1, new cjs.Rectangle(-0.6,0,150,262.2), null);
...
p.nominalBounds = new cjs.Rectangle(-0.7,0,168,381);
...
p.nominalBounds = new cjs.Rectangle(-0.7,0,169.5,380);
...
p.nominalBounds = new cjs.Rectangle(-1,0,169.5,380.5);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-1.85,0,0.5,0.5);
...
p.nominalBounds = new cjs.Rectangle(-1.8,0,134.5,384.5);
...
if (reversed == null) { reversed = false; }
	...
	this.instance_6.setTransform(117.05,82.3,0.2711,0.2711);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_2,p:{regY:93.5,scaleX:1,scaleY:1,x:134.05,y:116.1}},{t:this.instance_1},{t:this.instance}]}).to({state:[{t:this.instance_2,p:{regY:93.3,scaleX:1.25,scaleY:1.25,x:133.95,y:116}},{t:this.instance_4},{t:this.instance_3}]},1).to({state:[{t:this.instance_2,p:{regY:93.5,scaleX:1,scaleY:1,x:134.05,y:116.1}},{t:this.instance_6},{t:this.instance_5}]},1).wait(1));
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(30).to({_off:false},0).wait(1).to({regY:62,x:429.55,y:116.95},0).wait(1).to({x:373.6,y:124.35},0).wait(1).to({x:320.65,y:130.85},0).wait(1).to({x:270.75,y:136.5},0).wait(1).to({x:223.85,y:141.2},0).wait(1).to({x:179.9,y:145.05},0).wait(1).to({x:139,y:148},0).wait(1).to({x:101.1,y:150.05},0).wait(1).to({x:66.2,y:151.2},0).wait(1).to({x:34.3,y:151.5},0).wait(1).to({x:5.35,y:150.85},0).wait(1).to({x:-20.55,y:149.35},0).wait(1).to({x:-43.5,y:147},0).wait(1).to({x:-63.45,y:143.7},0).wait(1).to({x:-80.45,y:139.55},0).wait(1).to({x:-94.4,y:134.45},0).wait(1).to({x:-105.35,y:128.5},0).wait(1).to({x:-113.35,y:121.7},0).wait(1).to({x:-118.35,y:113.95},0).wait(1).to({x:-120.35,y:105.35},0).wait(1).to({x:-119.35,y:95.8},0).wait(1).to({x:-115.35,y:85.4},0).wait(1).to({x:-108.35,y:74.1},0).wait(1).to({x:-98.35,y:61.95},0).wait(1));

	// Layer_1
	this.instance_1 = new lib.Symbol1();
	this.instance_1.setTransform(-67.8,61.9,1,1,0,0,0,95.6,61.9);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(1).to({regY:62,x:-80.2,y:72},0).wait(1).to({x:-90.35,y:81.4},0).wait(1).to({x:-98.2,y:90.2},0).wait(1).to({x:-103.75,y:98.4},0).wait(1).to({x:-107,y:106},0).wait(1).to({x:-108,y:113},0).wait(1).to({x:-106.7,y:119.35},0).wait(1).to({x:-103.1,y:125.15},0).wait(1).to({x:-97.25,y:130.3},0).wait(1).to({x:-89.1,y:134.85},0).wait(1).to({x:-78.7,y:138.8},0).wait(1).to({x:-65.95,y:142.15},0).wait(1).to({x:-51,y:144.9},0).wait(1).to({x:-33.7,y:147.05},0).wait(1).to({x:-14.15,y:148.55},0).wait(1).to({x:7.7,y:149.5},0).wait(1).to({x:31.8,y:149.85},0).wait(1).to({x:58.2,y:149.55},0).wait(1).to({x:86.9,y:148.65},0).wait(1).to({x:117.85,y:147.15},0).wait(1).to({x:151.1,y:145.05},0).wait(1).to({x:186.65,y:142.35},0).wait(1).to({x:224.45,y:139.05},0).wait(1).to({x:264.6,y:135.15},0).wait(1).to({x:307,y:130.65},0).wait(1).to({x:351.7,y:125.5},0).wait(1).to({x:398.7,y:119.75},0).wait(1).to({x:448,y:113.45},0).wait(1).to({x:499.65,y:106.5},0).to({_off:true},1).wait(25));
...
p.nominalBounds = new cjs.Rectangle(-64.5,-125.9,161.2,296.3);
...
p.nominalBounds = new cjs.Rectangle(-64.7,-125.9,161.2,287.9);
...
if (reversed == null) { reversed = false; }
	...
	// ציפור_1
	this.instance = new lib.ציפור("synched",0);
	this.instance.setTransform(84.65,139.35,1.0938,1.0938,0,0,0,-560.8,-190.2);

	
	var _tweenStr_1 = cjs.Tween.get(this.instance).wait(1).to({regX:-564.9,regY:-191.2,x:84.45,y:138.05,startPosition:1},0).wait(1).to({x:88.8,y:137.85,startPosition:2},0).wait(1).to({x:93.1,y:137.65,startPosition:3},0).wait(1).to({x:97.4,y:137.45,startPosition:4},0).wait(1).to({x:101.75,y:137.3,startPosition:5},0).wait(1).to({x:106.05,y:137.1,startPosition:6},0).wait(1).to({x:110.4,y:136.9,startPosition:7},0).wait(1).to({x:114.7,y:136.7,startPosition:8},0).wait(1).to({x:119.05,y:136.5,startPosition:9},0).wait(1).to({x:123.35,y:136.35,startPosition:0},0).wait(1).to({x:127.7,y:136.15,startPosition:1},0).wait(1).to({x:132,y:135.95,startPosition:2},0).wait(1).to({x:136.35,y:135.75,startPosition:3},0).wait(1).to({x:140.65,y:135.55,startPosition:4},0).wait(1).to({x:145,y:135.4,startPosition:5},0).wait(1).to({x:149.3,y:135.2,startPosition:6},0).wait(1).to({x:153.65,y:135,startPosition:7},0).wait(1).to({x:157.95,y:134.8,startPosition:8},0).wait(1).to({x:162.3,y:134.6,startPosition:9},0).wait(1).to({x:166.6,y:134.45,startPosition:0},0).wait(1).to({x:170.95,y:134.25,startPosition:1},0).wait(1).to({x:175.25,y:134.05,startPosition:2},0).wait(1).to({x:179.6,y:133.85,startPosition:3},0).wait(1).to({x:183.9,y:133.65,startPosition:4},0).wait(1).to({x:188.25,y:133.5,startPosition:5},0).wait(1).to({x:192.55,y:133.3,startPosition:6},0).wait(1).to({x:196.9,y:133.1,startPosition:7},0).wait(1).to({x:201.2,y:132.9,startPosition:8},0).wait(1).to({x:205.55,y:132.7,startPosition:9},0).wait(1).to({x:209.85,y:132.55,startPosition:0},0).wait(1).to({x:214.2,y:132.35,startPosition:1},0).wait(1).to({x:218.5,y:132.15,startPosition:2},0).wait(1).to({x:222.8,y:131.95,startPosition:3},0).wait(1).to({x:227.15,y:131.75,startPosition:4},0).wait(1).to({x:231.45,y:131.6,startPosition:5},0).wait(1).to({x:235.8,y:131.4,startPosition:6},0).wait(1).to({x:240.1,y:131.2,startPosition:7},0).wait(1).to({x:244.45,y:131,startPosition:8},0).wait(1).to({x:248.75,y:130.85,startPosition:9},0).wait(1).to({x:253.1,y:130.65,startPosition:0},0).wait(1).to({x:257.4,y:130.45,startPosition:1},0).wait(1).to({x:261.75,y:130.25,startPosition:2},0).wait(1).to({x:266.05,y:130.05,startPosition:3},0).wait(1).to({x:270.4,y:129.9,startPosition:4},0).wait(1).to({x:274.7,y:129.7,startPosition:5},0).wait(1).to({x:279.05,y:129.5,startPosition:6},0).wait(1).to({x:283.35,y:129.3,startPosition:7},0).wait(1).to({x:287.7,y:129.1,startPosition:8},0).wait(1).to({x:292,y:128.95,startPosition:9},0).wait(1).to({x:296.35,y:128.75,startPosition:0},0).wait(1).to({x:300.65,y:128.55,startPosition:1},0).wait(1).to({x:305,y:128.35,startPosition:2},0).wait(1).to({x:309.3,y:128.15,startPosition:3},0).wait(1).to({x:313.65,y:128,startPosition:4},0).wait(1).to({x:317.95,y:127.8,startPosition:5},0).wait(1).to({x:322.3,y:127.6,startPosition:6},0).wait(1).to({x:326.6,y:127.4,startPosition:7},0).wait(1).to({x:330.95,y:127.2,startPosition:8},0).wait(1).to({x:335.25,y:127.05,startPosition:9},0).wait(1).to({x:339.55,y:126.85,startPosition:0},0).wait(1).to({x:343.9,y:126.65,startPosition:1},0).wait(1).to({x:348.2,y:126.45,startPosition:2},0).wait(1).to({x:352.55,y:126.25,startPosition:3},0).wait(1).to({x:356.85,y:126.1,startPosition:4},0).wait(1).to({x:361.2,y:125.9,startPosition:5},0).wait(1).to({x:365.5,y:125.7,startPosition:6},0).wait(1).to({x:369.85,y:125.5,startPosition:7},0).wait(1).to({x:374.15,y:125.3,startPosition:8},0).wait(1).to({x:378.5,y:125.15,startPosition:9},0).wait(1).to({x:382.8,y:124.95,startPosition:0},0).wait(1).to({x:387.15,y:124.75,startPosition:1},0).wait(1).to({x:391.45,y:124.55,startPosition:2},0).wait(1).to({x:395.8,y:124.35,startPosition:3},0).wait(1).to({x:400.1,y:124.2,startPosition:4},0).wait(1).to({x:404.45,y:124,startPosition:5},0).wait(1).to({x:408.75,y:123.8,startPosition:6},0).wait(1).to({x:413.1,y:123.6,startPosition:7},0).wait(1).to({x:417.4,y:123.4,startPosition:8},0).wait(1).to({x:421.75,y:123.25,startPosition:9},0).wait(1).to({x:426.05,y:123.05,startPosition:0},0).wait(1).to({x:430.4,y:122.85,startPosition:1},0).wait(1).to({x:434.7,y:122.65,startPosition:2},0).wait(1).to({x:439.05,y:122.5,startPosition:3},0).wait(1).to({x:443.35,y:122.3,startPosition:4},0).wait(1).to({x:447.7,y:122.1,startPosition:5},0).wait(1).to({x:452,y:121.9,startPosition:6},0).wait(1).to({x:456.35,y:121.7,startPosition:7},0).wait(1).to({x:460.65,y:121.55,startPosition:8},0).wait(1).to({x:464.95,y:121.35,startPosition:9},0).wait(1).to({x:469.3,y:121.15,startPosition:0},0).wait(1).to({x:473.6,y:120.95,startPosition:1},0).wait(1).to({x:477.95,y:120.75,startPosition:2},0).wait(1).to({x:482.25,y:120.6,startPosition:3},0).wait(1).to({x:486.6,y:120.4,startPosition:4},0).wait(1).to({x:490.9,y:120.2,startPosition:5},0).wait(1).to({x:495.25,y:120,startPosition:6},0).wait(1).to({x:499.55,y:119.8,startPosition:7},0).wait(1).to({x:503.9,y:119.65,startPosition:8},0).wait(1).to({x:508.2,y:119.45,startPosition:9},0).wait(1).to({x:512.55,y:119.25,startPosition:0},0).wait(1).to({x:516.85,y:119.05,startPosition:1},0).wait(1).to({x:521.2,y:118.85,startPosition:2},0).wait(1).to({x:525.5,y:118.7,startPosition:3},0).wait(1).to({x:529.85,y:118.5,startPosition:4},0).wait(1).to({x:534.15,y:118.3,startPosition:5},0).wait(1).to({x:538.5,y:118.1,startPosition:6},0).wait(1).to({x:542.8,y:117.9,startPosition:7},0).wait(1).to({x:547.15,y:117.75,startPosition:8},0).wait(1).to({x:551.45,y:117.55,startPosition:9},0).wait(1).to({x:555.8,y:117.35,startPosition:0},0).wait(1).to({x:560.1,y:117.15,startPosition:1},0).wait(1).to({x:564.45,y:116.95,startPosition:2},0).wait(1).to({x:568.75,y:116.8,startPosition:3},0).wait(1).to({x:573.1,y:116.6,startPosition:4},0).wait(1).to({x:577.4,y:116.4,startPosition:5},0).wait(1).to({x:581.75,y:116.2,startPosition:6},0).wait(1).to({x:586.05,y:116,startPosition:7},0).wait(1).to({x:590.35,y:115.85,startPosition:8},0).wait(1).to({x:594.7,y:115.65,startPosition:9},0).wait(1).to({x:599,y:115.45,startPosition:0},0).wait(1).to({x:603.35,y:115.25,startPosition:1},0).wait(1).to({x:607.65,y:115.1,startPosition:2},0).wait(1).to({x:612,y:114.9,startPosition:3},0).wait(1).to({x:616.3,y:114.7,startPosition:4},0).wait(1).to({x:620.65,y:114.5,startPosition:5},0).wait(1).to({x:624.95,y:114.3,startPosition:6},0).wait(1).to({x:629.3,y:114.15,startPosition:7},0).wait(1).to({x:633.6,y:113.95,startPosition:8},0).wait(1).to({x:637.95,y:113.75,startPosition:9},0).wait(1).to({x:642.25,y:113.55,startPosition:0},0).wait(1).to({x:646.6,y:113.35,startPosition:1},0).wait(1).to({x:650.9,y:113.2,startPosition:2},0).wait(1).to({x:655.25,y:113,startPosition:3},0).wait(1).to({x:659.55,y:112.8,startPosition:4},0).wait(1).to({x:663.9,y:112.6,startPosition:5},0).wait(1).to({x:668.2,y:112.4,startPosition:6},0).wait(1).to({x:672.55,y:112.25,startPosition:7},0).wait(1).to({x:676.85,y:112.05,startPosition:8},0).wait(1).to({x:681.2,y:111.85,startPosition:9},0).wait(1).to({x:685.5,y:111.65,startPosition:0},0).wait(1).to({x:689.85,y:111.45,startPosition:1},0).wait(1).to({x:694.15,y:111.3,startPosition:2},0).wait(1).to({x:698.5,y:111.1,startPosition:3},0).wait(1).to({x:702.8,y:110.9,startPosition:4},0).wait(1).to({x:707.15,y:110.7,startPosition:5},0).wait(1).to({x:711.45,y:110.5,startPosition:6},0).wait(1).to({x:715.75,y:110.35,startPosition:7},0).wait(1).to({x:720.1,y:110.15,startPosition:8},0).wait(1).to({x:724.4,y:109.95,startPosition:9},0).wait(1).to({x:728.75,y:109.75,startPosition:0},0).wait(1).to({x:733.05,y:109.55,startPosition:1},0).wait(1).to({x:737.4,y:109.4,startPosition:2},0).wait(1).to({x:741.7,y:109.2,startPosition:3},0).wait(1).to({x:746.05,y:109,startPosition:4},0).wait(1).to({x:750.35,y:108.8,startPosition:5},0).wait(1).to({x:754.7,y:108.6,startPosition:6},0).wait(1).to({x:759,y:108.45,startPosition:7},0).wait(1).to({x:763.35,y:108.25,startPosition:8},0).wait(1).to({x:767.65,y:108.05,startPosition:9},0).wait(1).to({x:772,y:107.85,startPosition:0},0).wait(1).to({x:776.3,y:107.65,startPosition:1},0).wait(1).to({x:780.65,y:107.5,startPosition:2},0).wait(1).to({x:784.95,y:107.3,startPosition:3},0).wait(1).to({x:789.3,y:107.1,startPosition:4},0).wait(1).to({x:793.6,y:106.9,startPosition:5},0).wait(1).to({x:797.95,y:106.75,startPosition:6},0).wait(1).to({x:802.25,y:106.55,startPosition:7},0).wait(1).to({x:806.6,y:106.35,startPosition:8},0).wait(1).to({x:810.9,y:106.15,startPosition:9},0).wait(1).to({x:815.25,y:105.95,startPosition:0},0).wait(1).to({x:819.55,y:105.8,startPosition:1},0).wait(1).to({x:823.9,y:105.6,startPosition:2},0).wait(1).to({x:828.2,y:105.4,startPosition:3},0).wait(1).to({x:832.55,y:105.2,startPosition:4},0).wait(1).to({x:836.85,y:105,startPosition:5},0).wait(1).to({x:841.15,y:104.85,startPosition:6},0).wait(1).to({x:845.5,y:104.65,startPosition:7},0).wait(1).to({x:849.8,y:104.45,startPosition:8},0).wait(1).to({x:854.15,y:104.25,startPosition:9},0).wait(1).to({x:858.45,y:104.05,startPosition:0},0).wait(1).to({x:862.8,y:103.9,startPosition:1},0).wait(1).to({x:867.1,y:103.7,startPosition:2},0).wait(1).to({x:871.45,y:103.5,startPosition:3},0).wait(1).to({x:875.75,y:103.3,startPosition:4},0).wait(1).to({x:880.1,y:103.1,startPosition:5},0).wait(1).to({x:884.4,y:102.95,startPosition:6},0).wait(1).to({x:888.75,y:102.75,startPosition:7},0).wait(1).to({x:893.05,y:102.55,startPosition:8},0).wait(1).to({x:897.4,y:102.35,startPosition:9},0).wait(1).to({x:901.7,y:102.15,startPosition:0},0).wait(1).to({x:906.05,y:102,startPosition:1},0).wait(1).to({x:910.35,y:101.8,startPosition:2},0).wait(1).to({x:914.7,y:101.6,startPosition:3},0).wait(1).to({x:919,y:101.4,startPosition:4},0).wait(1).to({x:923.35,y:101.2,startPosition:5},0).wait(1).to({x:927.65,y:101.05,startPosition:6},0).wait(1).to({x:932,y:100.85,startPosition:7},0).wait(1).to({x:936.3,y:100.65,startPosition:8},0).wait(1).to({x:940.65,y:100.45,startPosition:9},0).wait(1).to({x:944.95,y:100.25,startPosition:0},0).wait(1).to({x:949.3,y:100.1,startPosition:1},0).wait(1).to({x:953.6,y:99.9,startPosition:2},0).wait(1).to({x:957.95,y:99.7,startPosition:3},0).wait(1).to({x:962.25,y:99.5,startPosition:4},0).wait(1).to({x:966.55,y:99.35,startPosition:5},0).wait(1).to({x:970.9,y:99.15,startPosition:6},0).wait(1).to({x:975.2,y:98.95,startPosition:7},0).wait(1).to({x:979.55,y:98.75,startPosition:8},0).wait(1).to({x:983.85,y:98.55,startPosition:9},0).wait(1).to({x:988.2,y:98.4,startPosition:0},0).wait(1).to({x:992.5,y:98.2,startPosition:1},0).wait(1).to({x:996.85,y:98,startPosition:2},0).wait(1).to({x:1001.15,y:97.8,startPosition:3},0).wait(1).to({x:1005.5,y:97.6,startPosition:4},0).wait(1).to({x:1009.8,y:97.45,startPosition:5},0).wait(1).to({x:1014.15,y:97.25,startPosition:6},0).wait(1).to({x:1018.45,y:97.05,startPosition:7},0).wait(1).to({x:1022.8,y:96.85,startPosition:8},0).wait(1).to({x:1027.1,y:96.65,startPosition:9},0).wait(1).to({x:1031.45,y:96.5,startPosition:0},0).wait(1).to({x:1035.75,y:96.3,startPosition:1},0).wait(1).to({x:1040.1,y:96.1,startPosition:2},0).wait(1).to({x:1044.4,y:95.9,startPosition:3},0).wait(1).to({x:1048.75,y:95.7,startPosition:4},0).wait(1).to({x:1053.05,y:95.55,startPosition:5},0).wait(1).to({x:1057.4,y:95.35,startPosition:6},0).wait(1).to({x:1061.7,y:95.15,startPosition:7},0).wait(1).to({x:1066.05,y:94.95,startPosition:8},0).wait(1).to({x:1070.35,y:94.75,startPosition:9},0).wait(1).to({x:1074.7,y:94.6,startPosition:0},0).wait(1).to({x:1079,y:94.4,startPosition:1},0).wait(1).to({x:1083.35,y:94.2,startPosition:2},0).wait(1).to({x:1087.65,y:94,startPosition:3},0).wait(1).to({x:1091.95,y:93.8,startPosition:4},0).wait(1).to({x:1096.3,y:93.65,startPosition:5},0).wait(1).to({x:1100.6,y:93.45,startPosition:6},0).wait(1).to({x:1104.95,y:93.25,startPosition:7},0).wait(1).to({x:1109.25,y:93.05,startPosition:8},0).wait(1).to({x:1113.6,y:92.85,startPosition:9},0).wait(1).to({x:1117.9,y:92.7,startPosition:0},0).wait(1).to({x:1122.25,y:92.5,startPosition:1},0).wait(1).to({x:1126.55,y:92.3,startPosition:2},0).wait(1).to({x:1130.9,y:92.1,startPosition:3},0).wait(1).to({x:1135.2,y:91.95,startPosition:4},0).wait(1).to({x:1139.55,y:91.75,startPosition:5},0).wait(1).to({x:1143.85,y:91.55,startPosition:6},0).wait(1).to({x:1148.2,y:91.35,startPosition:7},0).wait(1).to({x:1152.5,y:91.15,startPosition:8},0).wait(1).to({x:1156.85,y:91,startPosition:9},0).wait(1).to({x:1161.15,y:90.8,startPosition:0},0).wait(1).to({x:1165.5,y:90.6,startPosition:1},0).wait(1).to({x:1169.8,y:90.4,startPosition:2},0).wait(1).to({x:1174.15,y:90.2,startPosition:3},0).wait(1).to({x:1178.45,y:90.05,startPosition:4},0).wait(1).to({x:1182.8,y:89.85,startPosition:5},0).wait(1).to({x:1187.1,y:89.65,startPosition:6},0).wait(1).to({x:1191.45,y:89.45,startPosition:7},0).wait(1).to({x:1195.75,y:89.25,startPosition:8},0).wait(1).to({x:1200.1,y:89.1,startPosition:9},0).wait(1).to({x:1204.4,y:88.9,startPosition:0},0).wait(1).to({x:1208.75,y:88.7,startPosition:1},0).wait(1).to({x:1213.05,y:88.5,startPosition:2},0).wait(1).to({x:1217.35,y:88.3,startPosition:3},0).wait(1).to({x:1221.7,y:88.15,startPosition:4},0).wait(1).to({x:1226,y:87.95,startPosition:5},0).wait(1).to({x:1230.35,y:87.75,startPosition:6},0).wait(1).to({x:1234.65,y:87.55,startPosition:7},0).wait(1).to({x:1239,y:87.35,startPosition:8},0).wait(1).to({x:1243.3,y:87.2,startPosition:9},0).wait(1).to({x:1247.65,y:87,startPosition:0},0).wait(1).to({x:1251.95,y:86.8,startPosition:1},0).wait(1).to({x:1256.3,y:86.6,startPosition:2},0).wait(1).to({x:1260.6,y:86.4,startPosition:3},0).wait(1).to({x:1264.95,y:86.25,startPosition:4},0).wait(1).to({x:1269.25,y:86.05,startPosition:5},0).wait(1).to({x:1273.6,y:85.85,startPosition:6},0).wait(1).to({x:1277.9,y:85.65,startPosition:7},0).wait(1).to({x:1282.25,y:85.45,startPosition:8},0).wait(1).to({x:1286.55,y:85.3,startPosition:9},0).wait(1).to({x:1290.9,y:85.1,startPosition:0},0).wait(1).to({x:1295.2,y:84.9,startPosition:1},0).wait(1).to({x:1299.55,y:84.7,startPosition:2},0).wait(1).to({x:1303.85,y:84.5,startPosition:3},0).wait(1).to({x:1308.2,y:84.35,startPosition:4},0).wait(1).to({x:1312.5,y:84.15,startPosition:5},0).wait(1).to({x:1316.85,y:83.95,startPosition:6},0).wait(1).to({x:1321.15,y:83.75,startPosition:7},0).wait(1).to({x:1325.5,y:83.6,startPosition:8},0).wait(1).to({startPosition:9},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:1},0).wait(1).to({startPosition:2},0).wait(1).to({startPosition:3},0).wait(1).to({startPosition:4},0).wait(1).to({startPosition:5},0).wait(1).to({startPosition:6},0).wait(1).to({startPosition:7},0).wait(1).to({startPosition:8},0).wait(1).to({startPosition:9},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:1},0).wait(1).to({startPosition:2},0).wait(1).to({startPosition:3},0).wait(1).to({startPosition:4},0).wait(1).to({startPosition:5},0).wait(1).to({startPosition:6},0).wait(1).to({startPosition:7},0).wait(1).to({startPosition:8},0).wait(1).to({startPosition:9},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:1},0).wait(1).to({startPosition:2},0).wait(1).to({startPosition:3},0).wait(1).to({startPosition:4},0).wait(1).to({startPosition:5},0).wait(1).to({startPosition:6},0).wait(1).to({startPosition:7},0).wait(1).to({startPosition:8},0).wait(1).to({startPosition:9},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:1},0).wait(1).to({startPosition:2},0).wait(1).to({startPosition:3},0).wait(1).to({startPosition:4},0).wait(1).to({startPosition:5},0).wait(1).to({startPosition:6},0).wait(1).to({startPosition:7},0).wait(1).to({startPosition:8},0).wait(1).to({startPosition:9},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:1},0).wait(1).to({startPosition:2},0).wait(1).to({startPosition:3},0).wait(1).to({startPosition:4},0).wait(1).to({startPosition:5},0).wait(1).to({startPosition:6},0).wait(1).to({startPosition:7},0).wait(1).to({startPosition:8},0).wait(1).to({startPosition:9},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:1},0).wait(1).to({startPosition:2},0).wait(1).to({startPosition:3},0).wait(1).to({startPosition:4},0).wait(1).to({startPosition:5},0).wait(1).to({startPosition:6},0).wait(1).to({startPosition:7},0).wait(1).to({startPosition:8},0).wait(1).to({startPosition:9},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:1},0).wait(1).to({startPosition:2},0).wait(1).to({startPosition:3},0).wait(1).to({startPosition:4},0).wait(1).to({startPosition:5},0).wait(1).to({startPosition:6},0).wait(1).to({startPosition:7},0).wait(1).to({startPosition:8},0).wait(1).to({startPosition:9},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:1},0).wait(1).to({startPosition:2},0).wait(1).to({startPosition:3},0).wait(1).to({startPosition:4},0).wait(1).to({startPosition:5},0).wait(1).to({startPosition:6},0).wait(1).to({startPosition:7},0).wait(1).to({startPosition:8},0).wait(1).to({startPosition:9},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:1},0).wait(1).to({startPosition:2},0).wait(1).to({startPosition:3},0).wait(1).to({startPosition:4},0).wait(1).to({startPosition:5},0).wait(1).to({startPosition:6},0).wait(1).to({startPosition:7},0).wait(1).to({startPosition:8},0).wait(1).to({startPosition:9},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:1},0).wait(1).to({startPosition:2},0).wait(1).to({startPosition:3},0).wait(1).to({startPosition:4},0).wait(1).to({startPosition:5},0).wait(1).to({startPosition:6},0).wait(1).to({startPosition:7},0).wait(1).to({startPosition:8},0).wait(1).to({startPosition:9},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:1},0).wait(1).to({startPosition:2},0).wait(1).to({startPosition:3},0).wait(1).to({startPosition:4},0).wait(1).to({startPosition:5},0).wait(1).to({startPosition:6},0).wait(1).to({startPosition:7},0).wait(1).to({startPosition:8},0).wait(1);
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(752).to({_off:false},0).to({regX:15.7,regY:22.7,scaleX:1.5598,scaleY:1.5598,x:-81.6,y:698,startPosition:23},258).to({_off:true,regX:0,regY:0,scaleX:0.5,scaleY:0.5,x:289.25,y:284.8},1).wait(33));
...
// stage content:
(lib.storybord = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.ציפור_1.setTransform(80.15,139.95,1.0269,1.0269,0,0,0,94.8,145.7);
	...
	this.timeline.addTween(cjs.Tween.get(this.ציפור_1).wait(1).to({regX:702.8,regY:110.9,scaleX:1,scaleY:1,x:688.2,y:105.2},0).wait(471).to({_off:true},1).wait(578));
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/CachedBmp_14.png?1650014268578", id:"CachedBmp_14"},
		{src:"images/CachedBmp_19.png?1650014268578", id:"CachedBmp_19"},
		{src:"images/CachedBmp_9.png?1650014268578", id:"CachedBmp_9"},
		{src:"images/CachedBmp_8.png?1650014268578", id:"CachedBmp_8"},
		{src:"images/CachedBmp_75.png?1650014268578", id:"CachedBmp_75"},
		{src:"images/CachedBmp_6.png?1650014268578", id:"CachedBmp_6"},
		{src:"images/CachedBmp_5.png?1650014268578", id:"CachedBmp_5"},
		{src:"images/CachedBmp_4.png?1650014268578", id:"CachedBmp_4"},
		{src:"images/CachedBmp_1.png?1650014268578", id:"CachedBmp_1"},
		{src:"images/story bord_atlas_1.png?1650014268186", id:"story bord_atlas_1"},
		{src:"images/story bord_atlas_2.png?1650014268186", id:"story bord_atlas_2"},
		{src:"images/story bord_atlas_3.png?1650014268186", id:"story bord_atlas_3"},
		{src:"images/story bord_atlas_4.png?1650014268186", id:"story bord_atlas_4"},
		{src:"sounds/John_Bartmann__09__Happy_Clappy1_1_wav.mp3?1650014268578", id:"John_Bartmann__09__Happy_Clappy1_1_wav"}
	],
	preloads: []
};
